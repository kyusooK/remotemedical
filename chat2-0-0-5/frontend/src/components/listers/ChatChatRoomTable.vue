...
<script>
    ...
    export default {
        ...
        async created() {
            ...
            temp.data._embedded.chatrooms.map(obj => obj.id=obj._links.self.href.split("/")[obj._links.self.href.split("/").length - 1])
            this.values = temp.data._embedded.chatrooms;
